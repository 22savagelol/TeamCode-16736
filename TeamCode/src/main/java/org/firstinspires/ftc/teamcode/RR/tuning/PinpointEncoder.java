...
@Metadata(
        ...
        d2 = {"Lcom/acmerobotics/roadrunner/ftc/PinpointEncoder;", "Lcom/acmerobotics/roadrunner/ftc/Encoder;", "pinpoint", "Lcom/acmerobotics/roadrunner/ftc/GoBildaPinpointDriverRR;", "usePerpendicular", "", "anyDummyMotor", "Lcom/qualcomm/robotcore/hardware/DcMotor;", "(Lcom/acmerobotics/roadrunner/ftc/GoBildaPinpointDriverRR;ZLcom/qualcomm/robotcore/hardware/DcMotor;)V", "controller", "Lcom/qualcomm/robotcore/hardware/DcMotorController;", "getController", "()Lcom/qualcomm/robotcore/hardware/DcMotorController;", "direction", "Lcom/qualcomm/robotcore/hardware/DcMotorSimple$Direction;", "getDirection", "()Lcom/qualcomm/robotcore/hardware/DcMotorSimple$Direction;", "setDirection", "(Lcom/qualcomm/robotcore/hardware/DcMotorSimple$Direction;)V", "getPositionAndVelocity", "Lcom/acmerobotics/roadrunner/ftc/PositionVelocityPair;", "sources for library Gradle: page.j5155.roadrunner:ftc-otos:0.1.14+0.3.1@aar"}
)
public final class PinpointEncoder implements Encoder {
    @NotNull
    ...
    public PinpointEncoder(@NotNull GoBildaPinpointDriver pinpoint, boolean usePerpendicular, @NotNull DcMotor anyDummyMotor) {
        super();
